...
export const DICIONARIO_COLUNAS: VerbeteColuna[] = [
  ...
  { id: 'emailOrgaoEstado', nome: 'E-mail ao órgão', grupo: 'Documentos', oQueE: 'Se o e-mail ao órgão (o do orçamento; sem ele, o último) foi ENTREGUE ou ABERTO. "Sem rastreio" = enviado antes de 23/09, não dá para saber. Clique para ver todos.', deOndeVem: 'Eventos do provedor de e-mail (ZeptoMail): entrega, abertura (pixel), devolução e spam.' },
