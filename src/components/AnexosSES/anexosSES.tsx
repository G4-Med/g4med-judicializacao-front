...
export const colunaAnexosSES = (dados?: any[]) => (
  <Column
    key="sesAnexos"
    field="sesAnexos"
    ...
    filterElement={filtroOpcoesDosDados(dados, (l: any) => l?.sesAnexos, 'Todos',
      (v: any) => (ESTADO as Record<string, any>)[v]?.rotulo ?? String(v))}
    style={{ width: '11rem' }}
